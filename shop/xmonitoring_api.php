 ...
 * @version    3968cba5ecdb78320d43cbe05a25fe35597bc800, v7 (xcart_4_7_0), 2015-02-17 13:29:01, xmonitoring_api.php, aim
...
if (!empty($active_modules['XMonitoring'])) {
    ...
    # Load module APIs
    #
    require "$xcart_dir/modules/XMonitoring/monitoring_api.php";
}
