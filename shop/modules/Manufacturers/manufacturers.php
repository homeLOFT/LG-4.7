 ...
 * @version    2b39e63712da5477e1aaf5cfa80d1370f583bce9, v74 (xcart_4_7_0), 2015-02-17 23:56:28, manufacturers.php, Yuriy
    ...
    if (
        ...
        if (!empty($manufacturerid)) {
            ...
            if (!$do_not_touch) {
                ...
                if (func_query_first_cell("SELECT COUNT(*) FROM " . $sql_tbl['manufacturers'] . " WHERE COLLATE $sql_collation manufacturer = '" . $manufacturer . "'") == 0) {
