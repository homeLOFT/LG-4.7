 ...
 * @version    2b39e63712da5477e1aaf5cfa80d1370f583bce9, v55 (xcart_4_7_0), 2015-02-17 23:56:28, customer_offers.php, Yuriy
...
IF ($sql_tbl[offer_bonuses].bonus_type='D',
    ...
    IF ($sql_tbl[offer_bonuses].bonus_type='N' AND $sql_tbl[offer_bonus_params].paramid IS NOT NULL,
        ...
        if (!empty($products)) {
            ...
            // This is very bad practice. Do not use $smarty->tpl_vars in a new code
            $smarty->tpl_vars['config']->value['Appearance']['max_select_quantity'] = "1";
        }
