 ...
 * @see    ____func_see____
 */
function func_fc_get_cache_path($path_type = 'web_path', $membershipid = 0, $l_language = '', $https_flag = 0)
{
    ...
    return
        ...
        intval($membershipid ?: $user_account['membershipid']) . '.' .
        ($l_language ?: $shop_language ) . '.' .
        intval($https_flag ?: $HTTPS) . '.html';
}
