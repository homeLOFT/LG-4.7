 ...
 * @version    2b39e63712da5477e1aaf5cfa80d1370f583bce9, v148 (xcart_4_7_0), 2015-02-17 23:56:28, func.payment.php, Yuriy
...
{ // {{{
    ...
    db_query("DELETE FROM $sql_tbl[payment_methods] WHERE processor_file='" . $processor . "'");
