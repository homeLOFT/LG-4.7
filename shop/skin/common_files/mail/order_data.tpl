{*
aa912c1999988fce95a7693876fc81d5f660a1c3, v6 (xcart_4_7_0), 2015-02-13 17:02:03, order_data.tpl, mixon
...
{if $tax.tax_value gt 0}{$tax.tax_display_name} {if $tax.rate_type eq "%"}{include file="main/display_tax_rate.tpl" value=$tax.rate_value}%{else}{currency value=$tax.rate_value}{/if}{/if}
...
{if $tax.rate_type eq "%"}{include file="main/display_tax_rate.tpl" value=$tax.rate_value assign="rate_value"}{assign var="tax_display_name" value="`$tax.tax_display_name` `$rate_value`%"}{else}{assign var="tax_display_name" value=$tax.tax_display_name}{/if}{$tax_display_name|mail_truncate}{currency value=$tax.tax_cost}
