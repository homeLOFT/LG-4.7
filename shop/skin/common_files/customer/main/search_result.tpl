{*
df07adee291d462827fbe587b7684ab509c64a27, v6 (xcart_4_6_5), 2014-07-17 21:01:28, search_result.tpl, aim
      ...
      <table cellspacing="0" cellpadding="0" class="width-100" summary="{$lng.lbl_search_products|escape}">
        <tbody>
          <tr>
            ...
            <td class="data-input pattern"><input type="text" name="posted_data[substring]" value="{$search_prefilled.substring|escape}" autofocus /></td>
