{*
aad85f2be3e7abf71f38a7de369cbd6188fe4f3b, v13 (xcart_4_7_0), 2015-02-11 09:38:53, contactus.tpl, aim
      ...
      <table cellspacing="0" class="data-table" summary="{$lng.lbl_contact_us|escape}">
        ...
        {if $default_fields.username.avail eq 'Y'}
          <tr>
            ...
            <td><input type="text" id="username" name="username" size="32" maxlength="128" value="{if $userinfo.username ne ''}{$userinfo.username|escape}{else}{$userinfo.login|escape}{/if}" {$autofocus} />
        ...
        {if $default_fields.company.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="company" name="company" size="32" value="{$userinfo.company|escape}" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.address.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="address" name="address" size="32" maxlength="255" value="{$userinfo.address|escape}" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.address_2.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="address_2" name="address_2" size="32" maxlength="255" value="{$userinfo.address_2|escape}" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.city.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="city" name="city" size="32" maxlength="64" value="{$userinfo.city|escape}" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.phone.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="phone" name="phone" size="32" maxlength="32" value="{$userinfo.phone|escape}" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.email.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="email" name="email" class="input-email" size="32" maxlength="128" value="{$userinfo.email|escape}" onchange="javascript: checkEmailAddress(this);" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.fax.avail eq 'Y'}
          <tr>
            ...
            <td><input type="text" id="fax" name="fax" size="32" maxlength="128" value="{$userinfo.fax|escape}" {$autofocus} />
            {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
        ...
        {if $default_fields.url.avail eq 'Y'}
          <tr>
            ...
            <td>
              <input type="text" id="url" name="url" size="32" maxlength="128" value="{if $userinfo.url eq ""}http://{else}{$userinfo.url|escape}{/if}" {$autofocus} />
              {assign var=autofocus value=''}
            </td>
          </tr>
        {/if}
