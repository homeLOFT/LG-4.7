{*
38b8aa6726346639939746532a52a2e9728bf403, v6 (xcart_4_7_0), 2015-02-27 10:32:33, tax_rates.tpl, mixon
...
{include file="main/display_tax_rate.tpl" value=$tax_rates[tax].rate_value assign="rate_value"}
<input type="text" size="20" maxlength="13" name="posted_data[{$tax_rates[tax].rateid}][rate_value]" value="{$rate_value}" />
