{*
0a3dc9d9b0b4a57a400cf44664beaea8b4ce0341, v19 (xcart_4_7_0), 2015-01-26 17:22:03, orders_list.tpl, mixon
...
{/if}
{if $active_modules.POS_System && $orders[oid].is_pos_order}<img title="{$lng.lbl_pos_order}" alt="{$lng.lbl_pos_order}" src="{$SkinDir}/modules/POS_System/images/pos_order.svg">{/if}
