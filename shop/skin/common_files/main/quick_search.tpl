{*
db9497b7f0df1d7a4ffe8ff80786986307846e99, v6 (xcart_4_6_4), 2014-05-30 13:35:16, quick_search.tpl, aim
...
<tr class="TableHead">
  ...
  <td width="5%" nowrap="nowrap">{if $orderby eq "is_anonymous_customer"}{include file="buttons/sort_pointer.tpl" dir=$sort}&nbsp;{/if}<a href="{$qscript|amp}&amp;sort=is_anonymous_customer{if $orderby eq "is_anonymous_customer"}&amp;sort_direction={if $sort eq 1}0{else}1{/if}{/if}">{$lng.lbl_type}</a></td>
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td width="5%" nowrap="nowrap">{if $user.is_anonymous_customer}{$lng.lbl_anonymous}{else}{$lng.lbl_registered|lower}{/if}</td>
