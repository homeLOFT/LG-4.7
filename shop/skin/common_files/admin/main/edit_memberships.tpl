{*
d19580b5f5f5d901a1315c71b3a6eada0239c273, v4 (xcart_4_6_4), 2014-04-07 17:45:38, edit_memberships.tpl, aim
...
<tr class="TableHead">
  ...
  {if $active_modules.POS_System ne ""}
    {include file="modules/POS_System/edit_memberships_pos_operator.tpl" page_section="header"}
  {/if}
...
{/if}
  ...
  {/if}
  {if $active_modules.POS_System ne ""}
    {include file="modules/POS_System/edit_memberships_pos_operator.tpl" page_section="data" name="posted_data[`$v.membershipid`][pos_operator]" pos_operator=$v.pos_operator}
  {/if}
