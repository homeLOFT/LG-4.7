{*
c0b7a742f56d4cd9d5875fb9a121be48c4674208, v2 (xcart_4_7_0), 2014-12-20 17:15:41, speed_bar.tpl, aim
...
<tr{cycle values=", class='TableSubHead'"}>
  ...
  <td>
  <input type="hidden" name="posted_data[{$smarty.section.sb.index}][id]" value="{$speed_bar[sb].id}" />
  <input type="text" size="3" maxlength="5" name="posted_data[{$smarty.section.sb.index}][orderby]" value="{$speed_bar[sb].orderby}" />
  </td>
  <td><input type="text" size="45" name="posted_data[{$smarty.section.sb.index}][title]" value="{$speed_bar[sb].title|escape}" /></td>
  <td><input type="text" size="45" name="posted_data[{$smarty.section.sb.index}][link]" value="{$speed_bar[sb].link|escape}" /></td>
  <td align="center"><input type="checkbox" name="posted_data[{$smarty.section.sb.index}][active]" value="Y"{if $speed_bar[sb].active eq "Y"} checked="checked"{/if} /></td>
</tr>
{/section}
