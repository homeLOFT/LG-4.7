{*
69db85f65a4a39e38570c701b38b3e32e41d22c2, v4 (xcart_4_6_5), 2014-08-21 15:00:45, product_set.tpl, aim
...
<tr>
  <td style="padding: 10px;">
    ...
    {if $is_first}
    <tr>
      <td colspan="4" align="center">{if $item_type eq "B" and $empty_params_lbl ne ""}{$empty_params_lbl}{elseif $item_type eq "C" && $params}{$lng.lbl_sp_no_products_selected}{else}{$lng.lbl_no_products_selected}{/if}</td>
    </tr>
    {/if}
    </table>
  </td>
