{*
16fd72c950254a8d4861815dac0d6147af93e43f, v3 (xcart_4_7_0), 2014-12-23 10:13:26, add_returns.tpl, aim
...
{foreach from=$return_products item=v name=returns}
    <tr{interline name=returns foreach_iteration="`$smarty.foreach.returns.iteration`" foreach_total="`$smarty.foreach.returns.total`"}>
      <td>
...
{inc assign="cnt" value=$smarty.section.i.index}
