{*
c0b7a742f56d4cd9d5875fb9a121be48c4674208, v3 (xcart_4_7_0), 2014-12-20 17:15:41, modify_return.tpl, aim
...
{section name=amnt loop=$return.product.amount+1 start=1}
      <option value="{$smarty.section.amnt.index}"{if $return.amount eq $smarty.section.amnt.index} selected="selected"{/if}>{$smarty.section.amnt.index}</option>
{/section}
    </select>
  </td>
</tr>
...
{section name=aamnt loop=$return.product.amount+1 start=0}
      <option value="{$smarty.section.aamnt.index}"{if $return.returned_amount eq $smarty.section.aamnt.index} selected="selected"{/if}>{$smarty.section.aamnt.index}</option>
{/section}
    </select>
  </td>
</tr>
