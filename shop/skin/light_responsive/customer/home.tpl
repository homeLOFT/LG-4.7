      ...
      <ul class="dropdown-menu" role="menu">
        ...
        <li class="col-sm-2">
          <ul>
			...
			<li><a href="https://www.leathergroups.com/blog/category/custom-leather-furniture-order-feed">Customer Order Gallery </a></li>
          </ul>
        </li>
          ...
          <ul class="dropdown-menu swatchNav">
            ...
            <div class="row swatchNavImg">
              <div class="col-sm-3"><div class="row swaGrid">
                ...
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Beige.jpg" alt="Italian Burnham Leather - Beige Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Beige2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
    			<div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Black.jpg" alt="Italian Burnham Leather - Black Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Black2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
    			<div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Dove.jpg" alt="Italian Burnham Leather - Dove Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Dove2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Molasses.jpg" alt="Italian Burnham Leather - Molasses Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Molasses2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Parchment.jpg" alt="Italian Burnham Leather - Parchment Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Parchment2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Slate.jpg" alt="Italian Burnham Leather - Slate Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Slate2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Burnham-Sycamore.jpg" alt="Italian Burnham Leather - Sycamore" onMouseOver="Tip('<img src=/color/swatches/el/Burnham-Sycamore2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
                ...
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Glove-Buckskin.jpg" alt="Italian Glove Buckskin Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Glove-Buckskin2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
                <div class="col-md-2 col-sm-2 col-xs-3 swatchSelect swatchTile"><a href="#" onClick="return false;"><img src="/color/swatches/el/Glove-Midnight-Blue.jpg" alt="Italian Glove Midnight Blue Full Grain Leather" onMouseOver="Tip('<img src=/color/swatches/el/Glove-Midnight-Blue2.jpg width=400 height=300>');" onMouseOut="UnTip()"/></a></div>
            ...
            <div class="col-sm-3">
              ...
              <div class="checkbox">
                <label>
                  <input type="checkbox" name="pigmented-earth-tones">Pigmented Leathers<br />(Browns and Earth Tones)</label>
              </div>
            </div>
            <div class="col-sm-3"><div class="row swaGrid">
            ...
            <div class="checkbox">
            <label>
              <input type="checkbox" name="pigmented-bright-tones">Pigmented Leathers<br />(Whites, Colors, Bright Tones)</label>
            </div>
          </div>
          <div class="col-sm-3"><div class="row swaGrid">
