  ...
  <ul class="nav navbar-nav navbar-right">
	...
	<div class="col-sm-10">
        ...
        <div class="row">
          ...
          <div class="col-md-6 col-xs-12"><p class="nav-content-det-note"><span class="glyphicon glyphicon-hand-right" aria-hidden="true"></span>&nbsp; NOTE: If your are using a Yahoo or AOL email address, please email us your request <a style="font-weight:400;" href="http://support.leathergroups.com/customer/portal/emails/new" target="_blank">HERE</a>. Do not use this form.</p>
           </div>
        </div>	
        <div class="row">
            <div class="col-md-12">
