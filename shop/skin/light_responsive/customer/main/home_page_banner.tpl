...
{else}
  ...
  <div class="welcome-img">
    <a href="http://www.x-cart.com">
    <img src="/common/images/welcome/Fabric-Upholstered-Furniture-at-SofaGroups.jpg" alt="Fabric Upholstered Sofa Collections" title="Fabric Upholstered Sofa Collections" />      <h1>Fabric Upholstered Sofa Collections</h1>
